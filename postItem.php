...
<div class="post-list">
  ...
  <div class="post-wrap-icon">
    ...
    <i class="fas fa-heart js-like-icon icon-pointer <?php if (isLogin() && !empty(getLikeCount($post['tool_id'], $_SESSION['user_id']))) echo 'fa-heart-active' ?>" data-tool_id="<?php echo $post['tool_id']; ?>"></i>
